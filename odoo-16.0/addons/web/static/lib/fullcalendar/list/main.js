...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ListEventRenderer = /** @class */ (function (_super) {
        ...
        ListEventRenderer.prototype.renderSegHtml = function (seg) {
            ...
            var classes = ['fc-list_'].concat(eventUi.classNames);
            ...
            return '<tr class="' + classes.join(' ') + '">' +
                (this.displayEventTime ?
                    '<td class="fc-list_-time ' + theme.getClass('widgetContent') + '">' +
                        (timeHtml || '') +
                        '</td>' :
                    '') +
                '<td class="fc-list_-marker ' + theme.getClass('widgetContent') + '">' +
                ...
                '></span>' +
                '</td>' +
                '<td class="fc-list_-title ' + theme.getClass('widgetContent') + '">' +
    ...
    */
    ...
    ListView.prototype.fgSegSelector = '.fc-list_'; // which elements accept event actions
